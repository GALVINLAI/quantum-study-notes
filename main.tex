...
%     \input{I Notes of NC book/1.1 Linear algebra/1.1.13 Partial trace/1.1.13.0}

% \subsubsection{Definition with reference to a basis}
% \input{I Notes of NC book/1.1 Linear algebra/1.1.13 Partial trace/1.1.13.1 Definition with reference to a basis}

% \subsubsection{Definition without reference to a basis}
% \input{I Notes of NC book/1.1 Linear algebra/1.1.13 Partial trace/1.1.13.2 Definition without reference to a basis}

% \subsubsection{Partial trace as a quantum operation} % 待处理, 重新放在别的位置
% \input{I Notes of NC book/1.1 Linear algebra/1.1.13 Partial trace/1.1.13.3 Partial trace as a quantum operation}
