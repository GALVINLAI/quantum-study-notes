...
\begin{theorem}[Quantum measurement postulate: projective measurement]
...
\begin{enumerate}
    ...
    \item \textbf{The emphasis is that we cannot calculate the value of probability $p_m$. However, we can sample according to $p_m$ (on a quantum computer).} % 我们不是真的不能计算probability $p_m$，而是这种计算会丧失使用量子技术的意义。
